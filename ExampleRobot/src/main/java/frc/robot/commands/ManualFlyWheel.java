...
public class ManualFlyWheel extends CommandBase {
    ...
    public ManualFlyWheel(XboxController operator, FlyWheel subsystem) {
    ...
    @Override
    public void execute() {
        double axis = m_operator.getRawAxis(2);
        m_flyWheel.setFlyWheelPower(axis);
    }

    // Called once the command ends or is interrupted.
    @Override
    public void end(boolean interrupted) {
        m_flyWheel.setFlyWheelPower(0);
    }
